...
def mqtt_device_demo(args):
	...
	#client.publish(mqtt_topic, payload, qos=1)
        ...
        stringadopo = "\","
        stringa2 = "\"t_v1\":\"34.00\",\"t_dhw1\":\"54.00\""
        stringa3 = "\"t_r1\":\"12.00\",\"t_hc_set\":\"2.00\",\"t_dhw_set\":\"23.00\",\"pump\":\"45\""
     
        inizio = "{" 
        virgola = "," 
        fine = "}"
 
        stringa = inizio+stringa1+stringatempo+stringadopo+stringa2+virgola+stringa3+fine

        client.publish(mqtt_topic,stringa,qos=1)
